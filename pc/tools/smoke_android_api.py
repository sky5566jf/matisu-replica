#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Android 真机冒烟：连 192.69.0.34:18183 跑与 iOS 同构的 17 项断言 Lua。
前置：adb install + app 启动 + 无障碍已开（见 2026-09-05 记忆）。
"""
...
s = socket.create_connection((HOST, CTRL_PORT), timeout=60)
...
try:
    ...
    smoke = [l for l in out.splitlines() if "SMOKE " in l]
